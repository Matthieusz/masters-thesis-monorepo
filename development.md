...
Depending on your workflow, you could want to exclude it from Git, for example if your project is public. In that case, provide the required values through your local environment or CI secrets.
